...
class inclusiveGST(GST):
    # def __init__(self,initial_price,tax):
    #     GST.__init__(self,initial_price,tax)
    #     self.add_tax=initial_price-initial_price/(1+tax/100)
    def __str__(self):
...
class subjectToGST(GST):
    # def __init__(self, initial_price, tax):
    #     GST.__init__(self, initial_price, tax)
    #     self.sub_tax=initial_price*tax/100
    def __str__(self):
...
class noGST(GST):
    ...
    #     GST.__init__(self,initial_price)
    def __str__(self):
        return f'\nAmount Payable : ${self.initial_price:>8.2f}'
